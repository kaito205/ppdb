        ...
        <div class="container-fluid px-3 px-md-5">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav align-items-lg-center mt-3 mt-lg-0">
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('/') ? 'active' : '' }}" href="#hero">Home</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="#pesantren">Pesantren</a></li>

                        </ul>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('tentang') ? 'active' : '' }}" href="#kegiatan"> Kegiatan
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('tentang') ? 'active' : '' }}" href="#ppdb"> Informasi
                        </a>
                    </li>


                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('tentang') ? 'active' : '' }}" href="#galeri">Galeria
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('kontak') ? 'active' : '' }}" href="#kontak">Contact</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
    ...
    <footer>
        <div class="container">
            ...
            <div class="text-center ">
                <small>&copy; 2025 SMA ERHA JATINAGARA. software development Kilayugung.</small>
            </div>
        </div>
    </footer>
