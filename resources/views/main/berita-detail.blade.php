                ...
                <div class="col-lg-8" data-aos="fade-up">
                    ...
                    <nav aria-label="breadcrumb" class="mb-3 mb-md-4">
                        <ol class="breadcrumb extra-small">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('berita.list') }}"
                    ...
                    <div class="sticky-top-sidebar">
                                ...
                                <form action="{{ route('berita.list') }}" method="GET">
                                    <div class="input-group input-group-sm">
                                        <input type="text" name="q"
                                            class="form-control rounded-start-pill border-end-0 shadow-none"
                                            placeholder="Kata kunci...">
                                        <button class="btn btn-blue rounded-end-pill px-3" type="submit"><i
                        ...
                        <div class="card border-0 shadow-sm rounded-4" data-aos="fade-left" data-aos-delay="100">
                            <div class="card-body p-4">
                                ...
                                <div
                                    class="d-flex align-items-center mb-3 pb-3 border-bottom last-no-border position-relative hvr-right">
                                    <img src="{{ asset('uploads/berita/'.$item->gambar) }}"
                                        class="rounded-3 object-fit-cover" width="65" height="65"
                                        alt="{{ $item->judul }}">
                                    <div class="ms-3">
